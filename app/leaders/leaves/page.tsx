                ...
                <CardContent className="space-y-4">
                    {pendingLeaves.length === 0 ? (
                        ...
                        pendingLeaves.map((leave) => (
                            <div
                                key={leave.id}
                                className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl border border-border/60 bg-white/[0.02] p-4 transition-all hover:bg-white/[0.04]"
                            >
            ...
            <Card className="border-border/60 bg-card">
                ...
                <CardContent className="space-y-3">
                    {historicalLeaves.length === 0 ? (
                        ...
                        historicalLeaves.slice(0, 5).map((leave) => (
                            <div
                                key={leave.id}
